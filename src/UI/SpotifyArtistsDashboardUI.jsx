...
import BreadCrumbSpotifyArtistsUI from './BreadCrumbSpotifyArtistsUI';
...
function SpotifyArtistsDashboardUI() {
  ...
  useEffect(() => {
    ...
    axios.post('/previous-spotify-results/?user=ehtisham&result_type=Spotify_Artists')
  ...
  const column_data_for_export = ["url", "name", "followers", "monthly_listens", "facebook","instagram", "twitter", "wikipedia"];
...
export default SpotifyArtistsDashboardUI;

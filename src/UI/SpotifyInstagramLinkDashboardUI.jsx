...
import BreadCrumbSpotifyInstagramLinkUI from './BreadCrumbSpotifyInstagramLinkUI';
...
function SpotifyInstagramLinkDashboardUI() {
  ...
  useEffect(() => {
    ...
    axios.post('/previous-spotify-results/?user=ehtisham&result_type=Instagram_Links')
  ...
  const column_data_for_export = ["url"];
  ...
  return (
    ...
    <React.Fragment>
      <div className='margin-left-right'>
        <BreadCrumbSpotifyInstagramLinkUI />
      </div>
...
export default SpotifyInstagramLinkDashboardUI;
